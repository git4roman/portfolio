...
export const aboutMe = {
  ...
  earlier: {
    ...
    second:
      "I consider myself as a well-disciplined and a bright student during my childhood. Even though my life turned dramatically into Techs, however I was once a student of Biological Science and wanted to persue more knowledge on Medical Science. Thus I did my pre-medics from Vibrant Institue in Kathmandu and started the preparation.",
    third:
